 ...
 */
    ...
    public static final String API_SHIPPING_ZONES = BASE_URL + "shipping/zones/" + BASE_AUTH;
    public static final String API_SHIPPING_ZONE_LOCATIONS = BASE_URL + "shipping/zones/{" + KEY_ID + "}"+"/locations/" + BASE_AUTH;
    public static final String API_SHIPPING_ZONE_METHODS = BASE_URL + "shipping/zones/{" + KEY_ID + "}"+"/methods/" + BASE_AUTH;
