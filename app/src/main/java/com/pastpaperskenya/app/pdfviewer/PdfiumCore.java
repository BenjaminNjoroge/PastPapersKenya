package com.pastpaperskenya.app.pdfviewer;
...
import com.pastpaperskenya.app.pdfviewer.util.Size;
...
public class PdfiumCore {
    ...
    public com.pastpaperskenya.app.pdfviewer.PdfDocument newDocument(ParcelFileDescriptor fd) throws IOException {
        return newDocument(fd, null);
    }

    /** Create new document from file with password */
    public com.pastpaperskenya.app.pdfviewer.PdfDocument newDocument(ParcelFileDescriptor fd, String password) throws IOException {
        com.pastpaperskenya.app.pdfviewer.PdfDocument document = new com.pastpaperskenya.app.pdfviewer.PdfDocument();
    ...
    public com.pastpaperskenya.app.pdfviewer.PdfDocument newDocument(byte[] data) throws IOException {
        return newDocument(data, null);
    }

    /** Create new document from bytearray with password */
    public com.pastpaperskenya.app.pdfviewer.PdfDocument newDocument(byte[] data, String password) throws IOException {
        com.pastpaperskenya.app.pdfviewer.PdfDocument document = new com.pastpaperskenya.app.pdfviewer.PdfDocument();
        synchronized (lock) {
    ...
    public int getPageCount(com.pastpaperskenya.app.pdfviewer.PdfDocument doc) {
        synchronized (lock) {
            return nativeGetPageCount(doc.mNativeDocPtr);
        }
    }

    /** Open page and store native pointer in {@link com.pastpaperskenya.app.pdfviewer.PdfDocument} */
    public long openPage(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int pageIndex) {
        long pagePtr;
        synchronized (lock) {
    ...
    /** Open range of pages and store native pointers in {@link com.pastpaperskenya.app.pdfviewer.PdfDocument} */
    public long[] openPage(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int fromIndex, int toIndex) {
        long[] pagesPtr;
        synchronized (lock) {
     ...
     */
    public int getPageWidth(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int index) {
        synchronized (lock) {
            Long pagePtr;
     ...
     * This method requires page to be opened.
     */
    public int getPageHeight(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int index) {
        synchronized (lock) {
            Long pagePtr;
            if ((pagePtr = doc.mNativePagesPtr.get(index)) != null) {
     ...
     * This method requires page to be opened.
     */
    public int getPageWidthPoint(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int index) {
        synchronized (lock) {
            Long pagePtr;
            if ((pagePtr = doc.mNativePagesPtr.get(index)) != null) {
     ...
     * This method requires page to be opened.
     */
    public int getPageHeightPoint(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int index) {
        synchronized (lock) {
            Long pagePtr;
            if ((pagePtr = doc.mNativePagesPtr.get(index)) != null) {
     ...
     */
    public Size getPageSize(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int index) {
        synchronized (lock) {
     ...
     */
    public void renderPage(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, Surface surface, int pageIndex,
     ...
     * </ul>
     */
    public void renderPageBitmap(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, Bitmap bitmap, int pageIndex,
                                 int startX, int startY, int drawSizeX, int drawSizeY) {
     ...
     * Page must be opened before rendering.
     * <p>
     * For more info see {@link PdfiumCore#renderPageBitmap(com.pastpaperskenya.app.pdfviewer.PdfDocument, Bitmap, int, int, int, int, int)}
     */
    public void renderPageBitmap(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, Bitmap bitmap, int pageIndex,
                                 int startX, int startY, int drawSizeX, int drawSizeY,
                                 boolean renderAnnot) {
    ...
    public void closeDocument(com.pastpaperskenya.app.pdfviewer.PdfDocument doc) {
        synchronized (lock) {
    ...
    public com.pastpaperskenya.app.pdfviewer.PdfDocument.Meta getDocumentMeta(com.pastpaperskenya.app.pdfviewer.PdfDocument doc) {
        synchronized (lock) {
            com.pastpaperskenya.app.pdfviewer.PdfDocument.Meta meta = new com.pastpaperskenya.app.pdfviewer.PdfDocument.Meta();
    ...
    public List<com.pastpaperskenya.app.pdfviewer.PdfDocument.Bookmark> getTableOfContents(com.pastpaperskenya.app.pdfviewer.PdfDocument doc) {
        synchronized (lock) {
            List<com.pastpaperskenya.app.pdfviewer.PdfDocument.Bookmark> topLevel = new ArrayList<>();
    ...
    private void recursiveGetBookmark(List<com.pastpaperskenya.app.pdfviewer.PdfDocument.Bookmark> tree, com.pastpaperskenya.app.pdfviewer.PdfDocument doc, long bookmarkPtr) {
        com.pastpaperskenya.app.pdfviewer.PdfDocument.Bookmark bookmark = new com.pastpaperskenya.app.pdfviewer.PdfDocument.Bookmark();
    ...
    public List<com.pastpaperskenya.app.pdfviewer.PdfDocument.Link> getPageLinks(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int pageIndex) {
        synchronized (lock) {
            List<com.pastpaperskenya.app.pdfviewer.PdfDocument.Link> links = new ArrayList<>();
            ...
            for (long linkPtr : linkPtrs) {
                ...
                if (rect != null && (index != null || uri != null)) {
                    links.add(new com.pastpaperskenya.app.pdfviewer.PdfDocument.Link(rect, index, uri));
                }
     ...
     */
    public Point mapPageCoordsToDevice(com.pastpaperskenya.app.pdfviewer.PdfDocument doc, int pageIndex, int startX, int startY, int sizeX,
                                       int sizeY, int rotate, double pageX, double pageY) {
    ...
    /**
     * @return mapped coordinates
     * @see PdfiumCore#mapPageCoordsToDevice(com.pastpaperskenya.app.pdfviewer.PdfDocument, int, int, int, int, int, int, double, double)
     */
